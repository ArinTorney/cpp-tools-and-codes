...
4. Math: Math library is no longer required. I could finally learn perspective projection matrices from ogldev, further improving it with GLM's source code, though yes, I have to learn orthographic projection and view matrices.  
