...
4. Math: Math library is no longer required. I could finally learn matrices from Etay Meiri(owner of ogldev)'s videos, though yes, I have to learn orthographic projection and view matrices.  
