...
3. Huge community: C++ has a huge community and therefore has many libraries to help programming in it, common ones of them licensed under less restrictive (either permissive or weak copyleft) licenses may be Boost for general purpose utility, SFML and Allegro for 2D graphics and multimedia, Irrlicht and Ogre for 3D graphics, wxWidgets and GTKmm for GUI, OpenAL soft for Audio files, Bullet for physics, GLM for mathematics, ImageMagick and STB for image loading, OpenGL and Vulkan for hardware accelerated graphics and GLFW and FreeGLUT for OpenGL window creation.  
